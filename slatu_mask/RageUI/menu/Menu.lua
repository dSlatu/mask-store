function RageUI.CreateMenu(Title, Subtitle, X, Y, TextureDictionary, TextureName, R, G, B, A)
    ...
    Menu.Index = 1
    Menu.Sprite = { Dictionary = TextureDictionary or "menuadmin.ytd", Texture = TextureName or "solazoneadmin", Color = { R = R, G = G, B = B, A = A } }
    Menu.Rectangle = nil
...
function RageUI.Menus:SetSpriteBanner(TextureDictionary, Texture)
    self.Sprite = { Dictionary = TextureDictionary or "commonmenu", Texture = Texture or "solazoneadmin" }
    self.Rectangle = nil
end
